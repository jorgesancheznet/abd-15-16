...
create  table provincias(
  ...
  superficie number(5),
  id_capital number(5) constraint provincias_fk1 references localidades
...
create table comunidades(
  ...
  id_capital number(5) constraint comunidades_fk1 references localidades
...
alter table provincias add constraint provincias_fk2
    foreign key(id_comunidad) references comunidades;
